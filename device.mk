...
PRODUCT_COPY_FILES += \
    device/google/taimen/default-permissions.xml:$(TARGET_COPY_OUT_VENDOR)/etc/default-permissions/default-permissions.xml \
...
$(call inherit-product, device/google/taimen/utils.mk)
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/init.hardware.usb.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/hw/init.taimen.usb.rc \
...
# power HAL
PRODUCT_PACKAGES += \
    android.hardware.power@1.1-service.taimen
...
PRODUCT_COPY_FILES += \
    device/google/taimen/nfc/libnfc-nci.conf:$(TARGET_COPY_OUT_VENDOR)/etc/libnfc-nci.conf \

PRODUCT_PACKAGES += \
    android.hardware.usb@1.1-service.taimen
...
# Vibrator HAL
PRODUCT_PACKAGES += \
    android.hardware.vibrator@1.1-service.taimen

# Thermal packages
PRODUCT_PACKAGES += \
    android.hardware.thermal@1.1-impl-taimen
...
# VR HAL
PRODUCT_PACKAGES += \
    android.hardware.vr@1.0-service.taimen \
...
PRODUCT_PACKAGES += \
    android.hardware.biometrics.fingerprint@2.1-service.taimen
...
PRODUCT_COPY_FILES += \
    device/google/taimen/tango_permissions.xml:system/etc/permissions/tango_permissions.xml \
    device/google/taimen/libtango_device2.jar:system/framework/libtango_device2.jar
...
PRODUCT_COPY_FILES += \
    device/google/taimen/permissions/com.google.hardware.camera.easel.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/com.google.hardware.camera.easel.xml
...
include device/google/taimen/device.mk
